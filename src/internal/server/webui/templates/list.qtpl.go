...
//line internal/server/webui/templates/list.qtpl:28
	qw422016.N().S(cacheId)
//line internal/server/webui/templates/list.qtpl:28
	qw422016.N().S(`">
    `)
//line internal/server/webui/templates/list.qtpl:29
	if customCSS {
//line internal/server/webui/templates/list.qtpl:29
...
//line internal/server/webui/templates/list.qtpl:36
		qw422016.N().S(`</a>`)
//line internal/server/webui/templates/list.qtpl:37
	}
//line internal/server/webui/templates/list.qtpl:38
	qw422016.N().S(`
        </div>
        <div class="row">
...
//line internal/server/webui/templates/list.qtpl:52
...
//line internal/server/webui/templates/list.qtpl:56
		qw422016.N().S(`<tr`)
//line internal/server/webui/templates/list.qtpl:57
		if file.IsDir {
//line internal/server/webui/templates/list.qtpl:57
			qw422016.N().S(` `)
//line internal/server/webui/templates/list.qtpl:57
...
//line internal/server/webui/templates/list.qtpl:58
...
//line internal/server/webui/templates/list.qtpl:63
		qw422016.N().S(`<td>`)
//line internal/server/webui/templates/list.qtpl:64
...
//line internal/server/webui/templates/list.qtpl:65
		qw422016.N().S(`</td></tr>`)
//line internal/server/webui/templates/list.qtpl:67
	}
//line internal/server/webui/templates/list.qtpl:68
	qw422016.N().S(`
            </tbody>
        </table>
    </main>
...
//line internal/server/webui/templates/list.qtpl:74
	qw422016.N().S(cacheId)
//line internal/server/webui/templates/list.qtpl:74
	qw422016.N().S(`"></script>
...
`)
//line internal/server/webui/templates/list.qtpl:77
}
